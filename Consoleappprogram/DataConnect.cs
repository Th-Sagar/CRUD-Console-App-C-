...
namespace Consoleappprogram
{
    internal class DataConnect
    {
        public static void Main(string[] args)
        {
            ...
            {
                conn.ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Trinity;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";

                try
                {
                    conn.Open();
                    Console.WriteLine("Sagar Thapa");
